...
export default function EduvosDecor(){
  return <div className="eduvos-decor" aria-hidden="true">
    <img className="decor decor-left-top" src="/brand/decor/eduvos-pattern-01.svg" alt=""/>
